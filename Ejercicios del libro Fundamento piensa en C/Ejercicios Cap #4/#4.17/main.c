...
tres regiones importantes del pa�s. Determina tambien cual es la region
...
/* Esta funcion obtiene la region con mayor promedio de lluvia anual. */
{
    if (R1 > R2)
        if (R1 > R3)
            printf("\nRegion con mayor promedio: Region Golfo. Promedio:
                   %6.2f", R1/12);                   )
                   else
                       printf("\nRegion con mayor promedio: Region Caribe Promedio:
                              %6.2f",R3 / 12);
                              else if (R2 > R3)
                              printf("\nRegi�n con mayor promedio: Region Pacifico. Promedio:
                                     %6.2f",R2 / 12);
                                     else
                                         printf("\nRegion con mayor promedio: Regin Caribe. Promedio:
                                                %6.2f",R3 / 12);
                }
