...
typedef struct /* Declaracio n de la estructura domicilio. */
{
    char cal[20]; /* Calle. */
    int num; /* N�mero. */
    char col[20]; /* Colonia. */
...
?hospital en cada una de las categorias de condicion. */
{
    ...
    printf("\nNumero pacientes en condici0n 1: %d", C1);
    printf("\nNumero pacientes en condici0n 2: %d", C2);
    printf("\nNumero pacientes en condici0n 3: %d", C3);
    printf("\nNumero pacientes en condici0n 4: %d", C4);
    printf("\nNumero pacientes en condici0n 5: %d", C5);
}
